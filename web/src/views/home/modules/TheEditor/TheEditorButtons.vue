  ...
  <div class="flex flex-row items-center justify-between px-2">
    ...
    <div class="flex flex-row items-center gap-2">
      ...
      <div v-if="hasContent || hasImage || hasExtension" class="relative group">
        ...
        <div
          class="absolute right-0 top-full z-10 mt-2 whitespace-nowrap rounded-md border border-[var(--border-color-400)] border-dashed bg-[var(--editor-bg-color)] px-2 py-1 text-xs shadow-lg opacity-0 translate-y-1 scale-95 pointer-events-none transition-all duration-200 ease-out group-hover:opacity-100 group-hover:translate-y-0 group-hover:scale-100 group-hover:pointer-events-auto"
        >
